...
public interface IPageManager
{
    ...
    Task<FinancialRecommendationsDto> GetFinancialRecommendationsAsync(CancellationToken cancellationToken);
    Task<BudgetPlanPageDto> GetBudgetPlanPageAsync(int planId, bool includeEvents, CancellationToken cancellationToken);
    Task<BudgetPlanPageDto> GetEventPageAsync(int eventId, CancellationToken cancellationToken);
