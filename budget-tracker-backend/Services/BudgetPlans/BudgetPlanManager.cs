...
public class BudgetPlanManager : IBudgetPlanManager
{
    ...
    private readonly IAutoBudgetPlanAlgorithm _autoBudgetPlanAlgorithm;

    public BudgetPlanManager(
        IApplicationDbContext context,
        IMapper mapper,
        IAutoBudgetPlanAlgorithm autoBudgetPlanAlgorithm)
    {
        _context = context;
        _mapper = mapper;
        _autoBudgetPlanAlgorithm = autoBudgetPlanAlgorithm;
    }
    ...
    {
        return await _autoBudgetPlanAlgorithm.CreateMonthlyPlanAsync(dto, cancellationToken);
    }
