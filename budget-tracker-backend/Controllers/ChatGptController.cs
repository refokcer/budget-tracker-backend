...
- "title" — 2-4 слова (если данных достаточно), коротко описывающих операцию. По возможности включай тип операции (например, продукты, техника, услуги, переводы) и конкретное название магазина/получателя. Не используй лишние символы и избегай общего слова "Покупка" без уточнений, если есть данные.
