        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnicCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_AccountFrom",
                        column: x => x.AccountFrom,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Accounts_AccountTo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountFrom",
                table: "Transactions",
                column: "AccountFrom");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_AccountTo",
                table: "Transactions",
                column: "AccountTo");
